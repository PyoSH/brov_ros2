"""Fresh Gazebo/SITL Case-C launch for the metadata-bound MK2 policy.

Mirrors ``sim2sim_mk2_case_a.launch.py`` exactly (same base bringup, same
Gazebo-truth bridge, same safe output defaults) but fixes the mission
profile to the MK2 5 m square / 0.5 m/s / random-attitude-per-corner
Case-C deployment contract (Sim2Swim Trial(c) analog) instead of Case-A's
2 m straight loop.
"""
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "mission_file": os.path.join(
                        bringup_share,
                        "config",
                        "mission_sim2sim_mk2_case_c_0p5.yaml",
                    ),
