"""Fresh Gazebo/SITL Case-C launch for the classical model-based controller.

Mirrors ``sim2sim_case_a_model_based.launch.py`` (same causal-isolation
purpose) but on the Case-C 5 m square / random-attitude-per-corner mission
instead of Case-A's 2 m straight loop.
"""
