...
#
# paper_ref_v1 added 2026-08-27.  It is the faithful Sim2Swim reproduction and
# satisfies every MK2 requirement: observation_contract brov_velocity_observation_v2,
# action_contract explicit_flu_zup_to_sname_frd_v1, and the default f_max, which
