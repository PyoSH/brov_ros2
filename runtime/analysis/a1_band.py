...
print(f"분석 구간: gain1.0 {d10:.0f}s, gain0.5 {d05:.0f}s   (1.8~2.6 Hz 대역 RMS)\n")
...
for ax in AX:
    ...
    for lbl, r in (("gain1.0", r10), ("gain0.5", r05)):
        d = r[ax]
    ...
    a, b = r10[ax], r05[ax]
    print(f"{'':6s} 비(0.5/1.0)   명령 대역 x{b['cmd_band']/max(a['cmd_band'],1e-9):.2f}   응답 대역 x{b['acc_band']/max(a['acc_band'],1e-9):.2f}\n")
